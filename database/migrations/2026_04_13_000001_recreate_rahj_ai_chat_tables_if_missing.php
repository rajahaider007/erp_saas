...
/**
 * Re-applies Rahj AI chat schema when older migrations are already marked "Ran"
 * but tables are missing (e.g. DB restore, manual drop, wrong database).
 */
return new class extends Migration
{
    ...
    {
        // Intentionally empty: do not drop chat history.
    }
};
