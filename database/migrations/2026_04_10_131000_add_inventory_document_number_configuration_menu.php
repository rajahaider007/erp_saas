...
return new class extends Migration
{
    public function up(): void
    {
        ...
        $route = '/inventory/document-number-configuration';

        if (DB::table('menus')->where('module_id', $inventory->id)->where('route', $route)->exists()) {
            return;
        }
        ...
        $menuId = DB::table('menus')->insertGetId([
            ...
            'menu_name' => 'Document Number Configuration',
            'route' => $route,
            'icon' => 'hash',
            'status' => 1,
    ...
    public function down(): void
    {
        ...
        DB::table('menus')
            ->where('module_id', $inventory->id)
            ->where('route', '/inventory/document-number-configuration')
            ->delete();
    }
};
