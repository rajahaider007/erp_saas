...
/**
 * Repair: 2026_04_09_230500 may be marked "Ran" while tables are missing (restore, manual drop, etc.).
 */
return new class extends Migration
{
    ...
    {
        // Do not drop: tables may pre-exist from original migration; repair migration is additive only.
    }
};
