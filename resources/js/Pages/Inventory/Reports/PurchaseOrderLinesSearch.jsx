...
import { ClipboardList, FileSpreadsheet, Filter, Home, RefreshCcw, Search } from 'lucide-react';
...
export default function PurchaseOrderLinesSearch() {
  ...
  const runReport = useCallback(() => {
    ...
    router.visit(`/inventory/reports/purchase-order-lines/report?${qs}`);
  }, [fromDate, toDate, vendorId, status, openLinesOnly, search, sortBy, sortOrder]);
  ...
  const breadcrumbItems = useMemo(
    () => [
      ...
      { label: tr('title'), href: '/inventory/reports/purchase-order-lines', icon: FileSpreadsheet },
    ],
    [t, ts, tr]
  );
          ...
          <div className="filter-card">
            ...
            <div className="filter-card-body">
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <div className="bg-slate-700/50 rounded-xl p-5 border border-slate-600/80">
                  <label className="text-xs font-semibold text-blue-400 uppercase tracking-wide mb-2 block" htmlFor="pol-s-vendor">
                    {tr('vendor')}
                  </label>
                  <select
                    id="pol-s-vendor"
                ...
                <div className="bg-slate-700/50 rounded-xl p-5 border border-slate-600/80">
                  <label className="text-xs font-semibold text-blue-400 uppercase tracking-wide mb-2 block" htmlFor="pol-s-status">
                    {tr('status')}
                  </label>
                  <select
                    id="pol-s-status"
