...
export default function List() {
  ...
  const visibleColumnsInit = useMemo(() => ({ id: true, classCode: true, className: true, trackingType: true, abcClassification: true, status: true, updatedAt: true, actions: true }), []);
    ...
    <App>
      <div className="advanced-module-manager">
        <div className="manager-header">
          <div className="header-main">
            ...
            <div className="header-actions">
              ...
              <a href='/inventory/item-class-coding/' className="btn btn-primary"><Plus size={20} />Add Item Class</a>
            </div>
          </div>
        ...
        <div className="data-table-container"><div className="table-wrapper"><table className="data-table"><thead><tr>
          ...
          {visibleColumns.trackingType && (<th><div className="th-content">Tracking Type</div></th>)}
          {visibleColumns.abcClassification && (<th><div className="th-content">ABC Classification</div></th>)}
          ...
          {paginatedItems.data.map((item) => (
            <tr key={item.id} className="table-row">
              ...
              {visibleColumns.trackingType && (<td>{item.tracking_type}</td>)}
              {visibleColumns.abcClassification && (<td>{item.abc_classification}</td>)}
