                      ...
                      <tbody>
                        {lines.map((row, index) => (
                          ...
                          >
                            ...
                            <td className="px-2 py-2">
                              <CustomDatePicker
                                selected={row.manufacturing_date ? new Date(row.manufacturing_date) : null}
                                onChange={(date) =>
                                  updateLine(index, {
                                    manufacturing_date: date ? date.toISOString().split('T')[0] : '',
                                  })
                                }
                                type="date"
                            ...
                            <td className="px-2 py-2">
                              <CustomDatePicker
                                selected={row.expiry_date ? new Date(row.expiry_date) : null}
                                onChange={(date) =>
                                  updateLine(index, {
