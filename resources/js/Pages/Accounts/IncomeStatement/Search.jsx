...
const IncomeStatementSearch = () => {
  ...
  const handleGenerateReport = () => {
    ...
    router.get('/accounts/income-statement/report?' + params.toString());
  };
          ...
          <div className="header-main">
            <div className="title-section">
              <h1 className="page-title">
                ...
                Income Statement - Report Filters
              </h1>
            ...
            <div className="filter-card-body">
              <div className="space-y-6">
                  ...
                  <>
                    <div className="bg-slate-700/50 rounded-xl p-6 border border-slate-600">
                      ...
                      <p className="text-xs text-gray-400 mt-2">
                        Select the company for which you want to view the income statement
                      </p>
                    </div>
                ...
                <div className="bg-slate-700/50 rounded-xl p-6 border border-slate-600">
                  ...
                  <p className="text-xs text-gray-400 mt-2">
                    Select the date range for the income statement period
                  </p>
                </div>
