      ...
      <App>
        <div className="min-h-screen bg-gray-50 flex items-center justify-center">
          <div className="text-center">
            ...
            <h2 className="text-xl font-semibold text-gray-900 mb-2">{t('accounts.journal_voucher.show.journal_voucher_not_found')}</h2>
            <p className="text-gray-600 mb-4">{t('accounts.journal_voucher.show.the_journal_voucher_youre_looking_for_do')}</p>
            <button
  ...
  return (
    <App>
      <div className="space-y-6">
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-4">
              ...
              <div>
                <h1 className="text-2xl font-bold text-gray-900">{t('accounts.journal_voucher.show.journal_voucher_details')}</h1>
                <p className="text-gray-600 mt-1">{t('accounts.journal_voucher.show.view_journal_voucher_information')}</p>
              </div>
            </div>
        ...
        {/* Voucher Information */}
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
          <h2 className="text-lg font-semibold text-gray-900 mb-4">{t('accounts.journal_voucher.show.voucher_information')}</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-1">{t('accounts.journal_voucher.show.voucher_number')}</label>
              <p className="text-sm text-gray-900 font-mono">{voucher.voucher_number}</p>
            </div>
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-1">{t('accounts.journal_voucher.show.voucher_date')}</label>
              <p className="text-sm text-gray-900">{new Date(voucher.voucher_date).toLocaleDateString()}</p>
            </div>
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-1">{t('accounts.journal_voucher.show.status')}</label>
            ...
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-1">{t('accounts.journal_voucher.show.currency')}</label>
          ...
          {voucher.reference_number && (
            <div className="mt-4">
              <label className="block text-sm font-medium text-gray-700 mb-1">{t('accounts.journal_voucher.show.reference_number')}</label>
              <p className="text-sm text-gray-900">{voucher.reference_number}</p>
            </div>
          )}
          
          <div className="mt-4">
            <label className="block text-sm font-medium text-gray-700 mb-1">{t('accounts.journal_voucher.show.description')}</label>
        ...
        {/* Journal Entries */}
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
          <h2 className="text-lg font-semibold text-gray-900 mb-4">{t('accounts.journal_voucher.show.journal_entries')}</h2>
        ...
        {/* Audit Information */}
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
          <h2 className="text-lg font-semibold text-gray-900 mb-4">{t('accounts.journal_voucher.show.audit_information')}</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-1">{t('accounts.journal_voucher.show.last_updated')}</label>
            ...
            {voucher.posted_at && (
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-1">{t('accounts.journal_voucher.show.posted_at')}</label>
