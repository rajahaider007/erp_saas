      ...
      <App>
        <div className="min-h-screen bg-gray-50 flex items-center justify-center">
          <div className="text-center">
            ...
            <h2 className="text-xl font-semibold text-gray-900 mb-2">Opening Voucher Not Found</h2>
            <p className="text-gray-600 mb-4">The Opening voucher you're looking for doesn't exist.</p>
            <button
  ...
  return (
    <App>
      <div className="space-y-6">
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-4">
              ...
              <div>
                <h1 className="text-2xl font-bold text-gray-900">Opening Voucher Details</h1>
                <p className="text-gray-600 mt-1">View Opening voucher information</p>
              </div>
            </div>
        ...
        {/* Opening Entries */}
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
          <h2 className="text-lg font-semibold text-gray-900 mb-4">Opening Entries</h2>
